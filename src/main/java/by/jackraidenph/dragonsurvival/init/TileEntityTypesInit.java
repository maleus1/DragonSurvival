...
public class TileEntityTypesInit {
    ...
    public static void registerTE(RegistryEvent.Register<TileEntityType<?>> event) {
        ...
        PREDATOR_STAR_TILE_ENTITY_TYPE = TileEntityType.Builder.create(PredatorStarTileEntity::new, BlockInit.predatorStarBlock).build(null);
        event.getRegistry().registerAll(nestEntityTile.setRegistryName(DragonSurvivalMod.MOD_ID, "dragon_nest"),
                PREDATOR_STAR_TILE_ENTITY_TYPE.setRegistryName(DragonSurvivalMod.MOD_ID, "predator_star_te"));
    }
}
